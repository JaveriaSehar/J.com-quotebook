...
- create_db.py – Creates database tables and sample quotes
- templates/ – HTML templates for index, login, register, inbox
- requirements.txt – Python dependencies
- README.md – Project description (this file)

#### Libraries Used:
Flask, SQLite3, Werkzeug

#### Features:
1. Random quote generation
2. Share quotes with other users
3. Inbox for received quotes
